...
ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ɴᴀᴍᴇ ᴏꜰ ᴛʜᴇ ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ ʏᴏᴜ ᴡᴀɴᴛ. 🔍</b>"""
    ...
    ABOUT_TXT = """<b>╭───────────⍟
├🤖 ᴍʏ ɴᴀᴍᴇ : ꜱᴘᴀʀᴋ x | ғɪʟᴛᴇʀ ғɪʟᴇ ꜱʜᴀʀɪɴɢ ʙᴏᴛ
├👑 ᴏᴡɴᴇʀ : <a href=https://t.me/MR_TechRobot>ᴏᴡɴᴇʀ</a>
├👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/MR_TechRobot>Sᴘᴀʀᴋ X | MR Tᴇᴄʜ</a>
...
3️⃣ ᴄʀᴇᴀᴛᴇ ᴀɴ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀ ꜱʜᴏʀᴛᴇɴᴇʀ (ᴇ.ɢ., <a href=https://arolinks.com/ref/Sumanth>Arolinks</a>).
...
ɪᴛ ʜᴀꜱ ᴇɪᴛʜᴇʀ ɴᴏᴛ ʙᴇᴇɴ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ʜᴀꜱ ɴᴏᴛ ʏᴇᴛ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ.</i></b>"""
    ...
    DISCLAIMER_TXT = """
<b>ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ᴀɴ ᴏᴘᴇɴ ꜱᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.
...
📜 <a href='https://mr-payweb.vercel.app'>Pay Here</a>
...
💳 ᴜᴘɪ ɪᴅ - <a href='https://mr-payweb.vercel.app'>Pay Here</a>
...
• /info - <code>ɢᴇᴛ ᴅᴇᴛᴀɪʟᴇᴅ ᴜꜱᴇʀ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ</code></b>"""
    ...
    SOURCE_TXT = """💎 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʀɪᴠᴀᴛᴇ ʙᴏᴛ

🔐 ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ᴀ ᴄᴜꜱᴛᴏᴍɪᴢᴇᴅ ᴠᴇʀꜱɪᴏɴ ᴀɴᴅ ɪꜱ ɴᴏᴛ ᴏᴘᴇɴ-ꜱᴏᴜʀᴄᴇ.
⚙️ ɪᴛ ɪɴᴄʟᴜᴅᴇꜱ ᴀᴅᴠᴀɴᴄᴇᴅ ғᴇᴀᴛᴜʀᴇꜱ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ᴇxᴄʟᴜꜱɪᴠᴇʟʏ ʙʏ ᴛʜᴇ ᴄʀᴇᴀᴛᴏʀ.

📩 ᴀᴄᴄᴇꜱꜱ ɪꜱ ʀᴇꜱᴛʀɪᴄᴛᴇᴅ.
ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ, ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴀᴅᴍɪɴ.

🚫 ᴜɴᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴄᴏᴘʏɪɴɢ, ᴄʟᴏɴɪɴɢ, ᴏʀ ᴅɪꜱᴛʀɪʙᴜᴛɪᴏɴ ɪꜱ ꜱᴛʀɪᴄᴛʟʏ ᴘʀᴏʜɪʙɪᴛᴇᴅ."""
